...
DynamicModelObject::DynamicModelObject(const glm::vec3 position, const glm::vec3 size,
...
DynamicModelObject::DynamicModelObject(Model* model, const glm::vec3 position, const glm::vec3 size,
									 const glm::vec3 velocity, const glm::vec4 color)
...
DynamicModelObject::~DynamicModelObject()
{
}

void DynamicModelObject::Update(GLfloat dt)
{
...
void DynamicModelObject::Draw(Renderer & renderer)
{
	renderer.DrawModel(this->mModel, this->mPosition, this->mRotation, this->mSize);
}

void DynamicModelObject::setupRigidBody()
{
	...
	this->mRigidBody = Physics::mPhysicsSDK->createRigidDynamic(transform);
